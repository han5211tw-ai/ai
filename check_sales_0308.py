...
# 讀取單獨的 0308 CSV
csv_path = "/Users/aiserver/srv/sync/OneDrive/ai_source/sales/銷貨0308.csv"
...
# 顯示比對結果
print("=" * 80)
print("比對結果：單獨 0308 CSV vs 資料庫 (2026/03/08)")
print("=" * 80)
...
if missing_in_csv:
    ...
    for r in missing_in_csv:
        print(f"  - 發票:{r['invoice_no']} | 產品:{r['product_name']} | 金額:{r['amount']}")
else:
    print("\n✓ 資料庫中的所有資料都在 CSV 中")
